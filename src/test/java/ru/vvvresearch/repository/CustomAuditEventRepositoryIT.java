...
import ru.vvvresearch.config.audit.AuditEventConverter;
import ru.vvvresearch.domain.PersistentAuditEvent;
...
import static ru.vvvresearch.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
