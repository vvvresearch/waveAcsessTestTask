...
/**
 * REST controller for managing {@link ru.vvvresearch.domain.Room}.
 */
@RestController
@RequestMapping("/api")
public class RoomResource {
     ...
     */
    @GetMapping("/rooms")
    public ResponseEntity<List<Room>> getAllRooms(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
